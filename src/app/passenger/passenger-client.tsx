...
interface PassengerClientProps {
    user: any; // Type this properly if possible, or use any for now
}

export default function PassengerClient({ user }: PassengerClientProps) {
